...
Scrapes BLS news release archive pages for CES, SAE, and QCEW; downloads release HTMLs and extracts release dates into parquet. Use the data for vintage-aware backtesting or nowcasting.
